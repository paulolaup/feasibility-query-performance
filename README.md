...
2. Configure the environment for each system if required as described in the **Container Configuration** section.
...
4. Set the run configuration you desire in **config/run_config.json**.
5. Start the tests by invoking the dedicated script in the terminal:
```bash
python run_performance_tests.py
```
The characteristics of the run can be configured by editing the **config/run_config.json**
file. Available attributes are explained below.
...
All systems that can be tested have 